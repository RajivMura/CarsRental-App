...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="View all listed cars, update their details, or remove form the bookings platform." />
            ...
            {cars.map((car, index) => (
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='flex items-center p-3'>
                  <img src={car.isAvaliable ? assets.eye_close_icon : assets.eye_close_icon} alt="" className='cursor-pointer' />
