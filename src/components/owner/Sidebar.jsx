...
import { assets, dummyCarData, dummyUserData, ownerMenuLinks } from '../../assets/assets'
...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      {image && (
        <button className='abosolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer'>Save <img src={assets.check_icon} alt="" width={13}  onClick={updateImage}/></button>
      )}
