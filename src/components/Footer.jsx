            ...
            <div className='flex flex-wrap justify-between items-start  gap-8 pb-6 border-borderColor'>
                <div >
                    ...
                    <div className='flex items-center gap-3 mt-6'>
                        ...
                        <a href="#">
                            <img src={assets.instagram_logo} className='w-5 h-5' alt="facebook" />

                        </a>
                        <a href="#">
                            <img src={assets.gmail_logo} className='w-5 h-5' alt="facebook" />

                        </a>
                        <a href="#">
                            <img src={assets.twitter_logo} className='w-5 h-5' alt="facebook" />
